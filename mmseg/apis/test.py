        ...
        if show or out_dir:
            ...
            if True:
                ...
                for img, img_meta in zip(imgs, img_metas):
                    ...
                    #####   
                    #import cv2
                    #cv2.imwrite(osp.join(out_dir, img_meta['ori_filename'][-4:]+'.png'),(result[i]-1)*255)
                    ####
                    ###
                    '''
                    print(out_dir)
                    print(img_meta['ori_filename'])
                    OutDic=os.path.join(out_dir,img_meta['ori_filename'][:-4])
                    print(OutDic)
                    ...
                    model.module.show_result(
                        ...
                        out_file=(OutDic, img_meta['filename'])
                        )
                    '''
                    '''
                    model.module.show_result(
