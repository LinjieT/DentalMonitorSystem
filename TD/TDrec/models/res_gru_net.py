...
from TD.TDrec.models.base_gru_net import BaseGRUNet
from TD.TDrec.lib.layers import FCConv3DLayer_torch, Unpool3DLayer, SoftmaxWithLoss3D
...
class decoder(nn.Module):
    def __init__(self, n_deconvfilter, h_shape):
        ...
        #3d conv7
        self.conv7a = Conv3d(n_deconvfilter[0], n_deconvfilter[1], 3, padding=1) #in_channels, out_channels, kernel_size=(3,3,3), padding=1
